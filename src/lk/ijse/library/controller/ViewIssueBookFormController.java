...
VeiwIssueBookBO issueBookBO= (VeiwIssueBookBO) BOFactory.getBoFactory().getBO(BOFactory.BOType.VEIWISSUEBOOK1);
    ...
    public void table() throws SQLException, ClassNotFoundException {
        ObservableList<IssueBookDTO> observableList=issueBookBO.loadAllPendingListToTable();
